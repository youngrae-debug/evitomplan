...
@section('content')
    ...
    <div class="max-w-screen-lg mx-auto flex items-center justify-center h-screen bg-gradient-to-b from-blue-900 to-gray-900 text-white rounded-3xl mx-4 mt-6 shadow-lg">
        <div class="text-center animate-fade-in">
            <!-- 큰 제목 -->
            <h1 class="text-5xl font-extrabold text-white mb-8 tracking-tight animate-fade-in">The Leading App for a Structured Life</h1>
            <div class="text-center max-w-3xl mx-auto">
                <p class="text-lg text-gray-300 mb-4 tracking-wide animate-fade-in-up">
                    Ready to <span class="text-blue-400 font-semibold">organize your life</span> like never before?
                </p>
                <p class="text-lg text-gray-300 mb-4 tracking-wide animate-fade-in-up delay-100">
                ...
                <p class="text-lg text-gray-300 mb-4 tracking-wide animate-fade-in-up delay-200">
                ...
                <p class="text-lg text-gray-300 mb-8 tracking-wide animate-fade-in-up delay-300">
        ...
        @if(session('success'))
            ...
            <div class="mt-8">
                <form action="/subscribe" method="POST" class="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0">
                    ...
                    <button type="submit"
                            class="md:ml-4 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:bg-blue-600 hover:scale-105 transform transition-all">
                        Subscribe
                    </button>
                </form>
            </div>
            ...
            <!-- 사용자 수와 리뷰 통계 -->
            <div class="flex justify-center space-x-6 mt-8 animate-fade-in-up">
            ...
            <div class="mt-12 flex justify-center space-x-4">
                <img src="/img/mainApp.png" alt="App Screenshot 1" class="h-64 w-auto rounded-lg shadow-lg hover:scale-105 transform transition-all duration-300">
                <img src="/img/mainApp.png" alt="App Screenshot 2" class="h-64 w-auto rounded-lg shadow-lg hover:scale-105 transform transition-all duration-300">
                <img src="/img/mainApp.png" alt="App Screenshot 3" class="h-64 w-auto rounded-lg shadow-lg hover:scale-105 transform transition-all duration-300">
            </div>
        </div>
    </div>
