...
@section('content')
    ...
    <!-- Hero Section -->
    <div class="flex items-center justify-center h-screen bg-gradient-to-b from-blue-900 to-gray-900 text-white rounded-3xl mx-4 mt-6 shadow-lg">
    <div class="text-center">
            ...
            <div class="mt-12 flex justify-center space-x-4">
                <img src="/path-to-image1.png" alt="App Screenshot 1" class="h-64 w-auto">
                <img src="/path-to-image2.png" alt="App Screenshot 2" class="h-64 w-auto">
            </div>
        </div>
    </div>
    ...
    <div id="cta" class="bg-gray-900 py-16 text-white rounded-3xl mx-4 mt-6 shadow-2xl text-center">
